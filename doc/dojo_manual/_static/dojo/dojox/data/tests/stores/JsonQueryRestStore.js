if(!dojo._hasResource["dojox.data.tests.stores.JsonQueryRestStore"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.data.tests.stores.JsonQueryRestStore"] = true;
