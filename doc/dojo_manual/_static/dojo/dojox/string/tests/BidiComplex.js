if(!dojo._hasResource["dojox.string.tests.BidiComplex"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["dojox.string.tests.BidiComplex"] = true;
