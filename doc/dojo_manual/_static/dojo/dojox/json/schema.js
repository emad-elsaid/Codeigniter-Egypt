...
_a.concat(_18(_c,_d.properties,_e,_d.additionalProperties));
}
}
...
if(typeof _1c!="object"||_1c instanceof Array){
_a.push({property:_1e,message:"an object is required"});
}
for(var i in _1d){
if(_1d.hasOwnProperty(i)){
var _21=_1c[i];
var _22=_1d[i];
_b(_21,_22,_1e,i);
}
...
for(i in _1c){
if(_1c.hasOwnProperty(i)&&(i.charAt(0)!="_"||i.charAt(0)!="_")&&_1d&&!_1d[i]&&_1f===false){
_a.push({property:_1e,message:(typeof _21)+"The property "+i+" is not defined in the schema and the schema does not allow additional properties"});
}
var _23=_1d&&_1d[i]&&_1d[i].requires;
if(_23&&!(_23 in _1c)){
_a.push({property:_1e,message:"the presence of the property "+i+" requires that "+_23+" also be present"});
}
_21=_1c[i];
if(_1d&&typeof _1d=="object"&&!(i in _1d)){
_b(_21,_1f,_1e,i);
}
if(!_9&&_21&&_21.$schema){
_a=_a.concat(_b(_21,_21.$schema,_1e,i));
}
}
return _a;
};
